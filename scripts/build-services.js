...
<footer class="bg-ink py-16 text-white/70">
  <div class="container-page">
    <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
      <div class="lg:col-span-2">
        ...
        <div class="mt-6 flex gap-3">
          <a href="https://www.facebook.com/profile.php?id=61590885743094" target="_blank" rel="noopener" aria-label="Kontanos en Facebook" class="flex h-10 w-10 items-center justify-center rounded-lg bg-white/5 transition-colors hover:bg-white/10 hover:text-white">
            <svg viewBox="0 0 24 24" class="h-4.5 w-4.5" fill="currentColor"><path d="M22 12a10 10 0 1 0-11.5 9.87v-6.99H7.9v-2.88h2.6V9.8c0-2.56 1.52-3.97 3.85-3.97 1.11 0 2.27.2 2.27.2v2.5h-1.28c-1.26 0-1.65.78-1.65 1.58v1.9h2.81l-.45 2.88h-2.36v6.99A10 10 0 0 0 22 12Z"/></svg>
          </a>
      ...
      <div>
        ...
        <ul class="mt-4 space-y-3 text-sm">
          ...
          <li><a href="https://jrramosalvarenga.github.io/pagina_personal/" target="_blank" rel="noopener" class="transition-colors hover:text-white">Blog del creador</a></li>
        </ul>
      </div>
    ...
    <div class="mt-14 border-t border-white/10 pt-10 text-center">
      <p class="text-xs font-semibold uppercase tracking-wider text-white/50">Con presencia y visión para toda Latinoamérica</p>
      <div class="mx-auto mt-5 flex max-w-3xl flex-wrap items-center justify-center gap-3">
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Argentina"><img src="https://flagcdn.com/w80/ar.png" alt="Argentina" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Chile"><img src="https://flagcdn.com/w80/cl.png" alt="Chile" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Perú"><img src="https://flagcdn.com/w80/pe.png" alt="Perú" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Bolivia"><img src="https://flagcdn.com/w80/bo.png" alt="Bolivia" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Paraguay"><img src="https://flagcdn.com/w80/py.png" alt="Paraguay" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Uruguay"><img src="https://flagcdn.com/w80/uy.png" alt="Uruguay" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Brasil"><img src="https://flagcdn.com/w80/br.png" alt="Brasil" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Colombia"><img src="https://flagcdn.com/w80/co.png" alt="Colombia" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Venezuela"><img src="https://flagcdn.com/w80/ve.png" alt="Venezuela" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Panamá"><img src="https://flagcdn.com/w80/pa.png" alt="Panamá" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-12 w-12 overflow-hidden rounded-full bg-accent/20 ring-2 ring-accent" title="Honduras"><img src="https://flagcdn.com/w80/hn.png" alt="Honduras" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Costa Rica"><img src="https://flagcdn.com/w80/cr.png" alt="Costa Rica" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Nicaragua"><img src="https://flagcdn.com/w80/ni.png" alt="Nicaragua" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="El Salvador"><img src="https://flagcdn.com/w80/sv.png" alt="El Salvador" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Guatemala"><img src="https://flagcdn.com/w80/gt.png" alt="Guatemala" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Belice"><img src="https://flagcdn.com/w80/bz.png" alt="Belice" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Ecuador"><img src="https://flagcdn.com/w80/ec.png" alt="Ecuador" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="México"><img src="https://flagcdn.com/w80/mx.png" alt="México" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Cuba"><img src="https://flagcdn.com/w80/cu.png" alt="Cuba" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="República Dominicana"><img src="https://flagcdn.com/w80/do.png" alt="República Dominicana" loading="lazy" class="h-full w-full object-cover"></span>
        <span class="block h-10 w-10 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10" title="Puerto Rico"><img src="https://flagcdn.com/w80/pr.png" alt="Puerto Rico" loading="lazy" class="h-full w-full object-cover"></span>
      </div>
    </div>
...
function servicePage(service) {
  ...
  const jsonLd = {
    ...
    provider: {
      ...
      sameAs: ["https://www.facebook.com/profile.php?id=61590885743094"],
    },
  };
